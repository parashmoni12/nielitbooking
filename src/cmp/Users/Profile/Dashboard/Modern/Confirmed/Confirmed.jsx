                    ...
                    <Card sx={{width:{xs:"270px",md:"300px"},height:"120px",mt:4}}>
                            ...
                            <CardContent>
                                ...
                                <Grid container alignItems="center">
                                    ...
                                    <Grid item>
                                            <Avatar sx={{ bgcolor: cyan[500], textDecoration:"none" }} component={Link} to="/profile/confirmed-bookings">
                                            <span className="material-icons">account_circle </span>
                                            </Avatar>
                                    </Grid>
                                    <Grid item> <Typography sx={{fontFamily:"Mooli",ml:1}}> Confirmed </Typography></Grid>

                                </Grid>


                                    
                                        <Avatar sx={{ bgcolor: cyan[400], marginLeft:{xs:"200px",md:"220px"},marginTop:"15px",textDecoration:"none"}} component={Link} to="/profile/confirmed-bookings">{count}</Avatar>
